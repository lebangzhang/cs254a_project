...
VX_CFLAGS  += -I$(ROOT_DIR)/hw -I$(VORTEX_HOME)/kernel/include -DXLEN_$(XLEN) -DNDEBUG $(CONFIGS) -D__VORTEX__
...
$(PROJECT): $(OBJS) $(VORTEX_KN_PATH)/libvortex.a $(VORTEX_RT_PATH)/libvortex.so
