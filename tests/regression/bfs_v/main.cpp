...
void generate_random_graph(int num_nodes, uint max_edges_per_node, 
                           std::vector<Node>& nodes, std::vector<uint32_t>& edges) {
...
static void show_usage() {
   ...
   std::cout << "Usage: [-k: kernel] [-v vector length per thread][-n words] [-h: help]" << std::endl;
}
...
int main(int argc, char *argv[]) {
  ...
  /*uint32_t num_edges = 48;*/

  uint32_t nodes_buf_size = num_nodes  * sizeof(Node);
  uint32_t edges_buf_size = num_edges  * sizeof(uint32_t);  
  uint32_t cost_buf_size  = num_nodes  * sizeof(uint32_t);
  ...
  kernel_arg.num_threads_to_run = num_nodes/vec_len_per_thread;
  ...
  std::vector<uint32_t> h_src1(num_edges);
  std::vector<uint32_t> h_src2(num_nodes);
  std::vector<uint32_t> h_src3(num_nodes);
  std::vector<uint32_t> h_src4(num_nodes);
  std::vector<uint32_t> h_src5(num_nodes);
  std::vector<uint32_t> h_dst(num_nodes);
...
/*  int h_edges[12] = { 2,7,2,5,1,4,4,6,4,1,5, 6};*/
      ...
      /*
 Node h_nodes[32] = { 
    {0, 3},    // Node 0 edges start at 0, 3 edges 
    {3, 2},    // Node 1 edges start at 3, 2 edges 
    {5, 3},    // Node 2 edges start at 5, 3 edges 
    {8, 1},    // Node 3 edges start at 8, 1 edge 
    {9, 1},    // Node 4 edges start at 9, 1 edge 
    {10, 1},   // Node 5 edges start at 10, 1 edge
    {11, 0},   // Node 6 no edges 
    {11, 1},   // Node 7 edges start at 11, 1 edge 
    {12, 3},   // Node 8 edges start at 12, 3 edges
    {15, 2},   // Node 9 edges start at 15, 2 edges
    {17, 1},   // Node 10 edges start at 17, 1 edge 
    {18, 1},   // Node 11 edges start at 18, 1 edge 
    {19, 3},   // Node 12 edges start at 19, 3 edges
    {22, 2},   // Node 13 edges start at 22, 2 edges
    {24, 1},   // Node 14 edges start at 24, 1 edge 
    {25, 3},   // Node 15 edges start at 25, 3 edges
    {28, 1},   // Node 16 edges start at 28, 1 edge 
    {29, 0},   // Node 17 no edges 
    {29, 2},   // Node 18 edges start at 29, 2 edges
    {31, 1},   // Node 19 edges start at 31, 1 edge 
    {32, 2},   // Node 20 edges start at 32, 2 edges
    {34, 0},   // Node 21 no edges 
    {34, 1},   // Node 22 edges start at 34, 1 edge 
    {35, 2},   // Node 23 edges start at 35, 2 edges
    {37, 0},   // Node 24 no edges 
    {37, 1},   // Node 25 edges start at 37, 1 edge 
    {38, 1},   // Node 26 edges start at 38, 1 edge 
    {39, 1},   // Node 27 edges start at 39, 1 edge 
    {40, 2},   // Node 28 edges start at 40, 2 edges
    {42, 1},   // Node 29 edges start at 42, 1 edge 
    {43, 1},   // Node 30 edges start at 43, 1 edge 
    {44, 3}    // Node 31 edges start at 44, 3 edges
 }; 
*/

/*
 uint32_t h_edges[48] = { 
    2, 23, 10,           // Node 0 neighbors
    13, 1,               // Node 1 neighbors 
    20, 4, 6,             //Node 2 neighbors 
    28,                   //Node 3 neighbors 
    1,                    //Node 4 neighbors 
    21,                   //Node 5 neighbors 
                         //Node 6 has no neighbors
    22,                   //Node 7 neighbors
    0, 20, 25,            //Node 8 neighbors 
    16, 28,               //Node 9 neighbors 
    0,                    //Node 10 neighbors 
    26,                   //Node 11 neighbors 
    16, 1, 17,            //Node 12 neighbors 
    10, 3,                //Node 13 neighbors 
    14,                   //Node 14 neighbors 
    3, 8, 31,             //Node 15 neighbors 
    25,                   //Node 16 neighbors 
    29,                  // Node 17 has no neighbors 
    1, 12,               // Node 18 neighbors 
    5,                   // Node 19 neighbors
    21, 17,              // Node 20 neighbors
                         // Node 21 has no neighbors 
    2,                   // Node 22 neighbors 
    27, 27,              // Node 23 neighbors 
                         // Node 24 has no neighbors
    27,                  // Node 25 neighbors 
    22,                  // Node 26 neighbors 
    5,                   // Node 27 neighbors 
    6, 16,               // Node 28 neighbors 
    22,                  // Node 29 neighbors 
    24,                  // Node 30 neighbors 
    29, 29, 23           // Node 31 neighbors 
 }; 
*/
  ...
  // Run Golden Results
  std::vector<uint32_t> cost(num_nodes);
  bfs_cpu(h_nodes.data(), h_edges.data(), num_nodes, 0, cost.data());
  /*bfs_cpu(h_nodes, h_edges, num_nodes, 0, cost.data());*/
