...
`endif
    ...
    VX_elastic_buffer #(
        ...
        .data_in  ({execute_if.data.uuid, execute_if.data.wid, execute_if.data.lid, execute_if.data.tmask, execute_if.data.rd, execute_if.data.wb, execute_if.data.pid, execute_if.data.sop, execute_if.data.eop, alu_result,   execute_if.data.PC, cbr_dest,   is_br_op,   br_op,   last_tid}),
