...
class AraLaneUnit : public SimObject<AraLaneUnit> {
...
public:
            ...
            , op_rsp_port(num_ara2_lane_insn, this)
    {
        ...
        op_req_unit = AraOperandRequestor::Create();
    ...
    virtual void tick() {
        ...
        for(uint32_t i=0; i < num_ara2_lane_insn; i++){
            ...
            if(this->op_req_port.at(i).empty()){
                ...
                DT(3, "Ara-AraLaneUnit: To op_req_port : " << i << " Received request " << *trace);
