...
bool Emulator::executeVector(const Instr &instr, uint32_t wid, uint32_t tid, const std::vector<reg_data_t>& rs1_data, const std::vector<reg_data_t>& rs2_data, std::vector<reg_data_t>& rd_data) {
  ...
  case 0: { // vector - vector
    ...
    case 2: { // vsub.vv
      vector_op_vv<Sub, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 4: { // vminu.vv
      vector_op_vv<Min, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 5: { // vmin.vv
      vector_op_vv<Min, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 6: { // vmaxu.vv
      vector_op_vv<Max, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 7: { // vmax.vv
      vector_op_vv<Max, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 9: { // vand.vv
      vector_op_vv<And, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 10: { // vor.vv
      vector_op_vv<Or, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 11: { // vxor.vv
      vector_op_vv<Xor, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 12: { // vrgather.vv
      vector_op_vv_gather<uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, false, warp.vlmax, vmask);
    } break;
    case 14: { // vrgatherei16.vv
      vector_op_vv_gather<uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, true, warp.vlmax, vmask);
    } break;
    case 16: { // vadc.vvm
      vector_op_vv_carry<Adc, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl);
    } break;
    case 17: { // vmadc.vv, vmadc.vvm
      vector_op_vv_carry_out<Madc, uint8_t, uint16_t, uint32_t, uint64_t, __uint128_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 18: { // vsbc.vvm
      vector_op_vv_carry<Sbc, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl);
    } break;
    case 19: { // vmsbc.vv, vmsbc.vvm
      vector_op_vv_carry_out<Msbc, uint8_t, uint16_t, uint32_t, uint64_t, __uint128_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 23: {
      if (vmask) { // vmv.v.v
        if (rsrc1 != 0) {
        ...
        vector_op_vv<Mv, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
      } else { // vmerge.vvm
        vector_op_vv_merge<int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
      }
    } break;
    case 24: { // vmseq.vv
      vector_op_vv_mask<Eq, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 25: { // vmsne.vv
      vector_op_vv_mask<Ne, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 26: { // vmsltu.vv
      vector_op_vv_mask<Lt, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 27: { // vmslt.vv
      vector_op_vv_mask<Lt, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 28: { // vmsleu.vv
      vector_op_vv_mask<Le, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 29: { // vmsle.vv
      vector_op_vv_mask<Le, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 30: { // vmsgtu.vv
      vector_op_vv_mask<Gt, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 31: { // vmsgt.vv
      vector_op_vv_mask<Gt, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 32: { // vsaddu.vv
      vector_op_vv_sat<Sadd, uint8_t, uint16_t, uint32_t, uint64_t, __uint128_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask, 2, vcsrs.vxsat);
    } break;
    case 33: { // vsadd.vv
      vector_op_vv_sat<Sadd, int8_t, int16_t, int32_t, int64_t, __int128_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask, 2, vcsrs.vxsat);
    } break;
    case 34: { // vssubu.vv
      vector_op_vv_sat<Ssubu, uint8_t, uint16_t, uint32_t, uint64_t, __uint128_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask, 2, vcsrs.vxsat);
    } break;
    case 35: { // vssub.vv
      vector_op_vv_sat<Ssub, int8_t, int16_t, int32_t, int64_t, __int128_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask, 2, vcsrs.vxsat);
    } break;
    case 37: { // vsll.vv
      vector_op_vv<Sll, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 39: { // vsmul.vv
      vector_op_vv_sat<Smul, int8_t, int16_t, int32_t, int64_t, __int128_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask, vcsrs.vxrm, vcsrs.vxsat);
    } break;
    case 40: { // vsrl.vv
      vector_op_vv<SrlSra, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 41: { // vsra.vv
      vector_op_vv<SrlSra, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 42: { // vssrl.vv
      uint32_t vxsat = 0; // saturation is not relevant for this operation
      vector_op_vv_scale<SrlSra, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask, vcsrs.vxrm, vxsat);
    } break;
    case 43: { // vssra.vv
      uint32_t vxsat = 0; // saturation is not relevant for this operation
      vector_op_vv_scale<SrlSra, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask, vcsrs.vxrm, vxsat);
    } break;
    case 44: { // vnsrl.wv
      uint32_t vxsat = 0; // saturation is not relevant for this operation
      vector_op_vv_n<SrlSra, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask, 2, vxsat);
    } break;
    case 45: { // vnsra.wv
      uint32_t vxsat = 0; // saturation is not relevant for this operation
      vector_op_vv_n<SrlSra, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask, 2, vxsat);
    } break;
    case 46: { // vnclipu.wv
      vector_op_vv_n<Clip, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask, vcsrs.vxrm, vcsrs.vxsat);
    } break;
    case 47: { // vnclip.wv
      vector_op_vv_n<Clip, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask, vcsrs.vxrm, vcsrs.vxsat);
    } break;
    case 48: { // vwredsumu.vs
      vector_op_vv_red_w<Add, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 49: { // vwredsum.vs
  ...
  case 1: { // float vector - vector
    ...
    case 2: { // vfsub.vv
      vector_op_vv<Fsub, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 1:   // vfredusum.vs - treated the same as vfredosum.vs
    case 3: { // vfredosum.vs
      vector_op_vv_red<Fadd, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 4: { // vfmin.vv
      vector_op_vv<Fmin, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 5: { // vfredmin.vs
      vector_op_vv_red<Fmin, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 6: { // vfmax.vv
      vector_op_vv<Fmax, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 7: { // vfredmax.vs
      vector_op_vv_red<Fmax, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 8: { // vfsgnj.vv
      vector_op_vv<Fsgnj, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 9: { // vfsgnjn.vv
      vector_op_vv<Fsgnjn, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 10: { // vfsgnjx.vv
    ...
    case 18: {
      ...
      case 0b00: // vfcvt.xu.f.v, vfcvt.x.f.v, vfcvt.f.xu.v, vfcvt.f.x.v, vfcvt.rtz.xu.f.v, vfcvt.rtz.x.f.v
        vector_op_vix<Fcvt, uint8_t, uint16_t, uint32_t, uint64_t>(rsrc0, vreg_file, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
        break;
      case 0b01: // vfwcvt.xu.f.v, vfwcvt.x.f.v, vfwcvt.f.xu.v, vfwcvt.f.x.v, vfwcvt.f.f.v, vfwcvt.rtz.xu.f.v, vfwcvt.rtz.x.f.v
        vector_op_vix_w<Fcvt, uint8_t, uint16_t, uint32_t, uint64_t>(rsrc0, vreg_file, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
        break;
      case 0b10: { // vfncvt.xu.f.w, vfncvt.x.f.w, vfncvt.f.xu.w, vfncvt.f.x.w, vfncvt.f.f.w, vfncvt.rod.f.f.w, vfncvt.rtz.xu.f.w, vfncvt.rtz.x.f.w
        ...
        vector_op_vix_n<Fcvt, uint8_t, uint16_t, uint32_t, uint64_t>(rsrc0, vreg_file, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask, vcsrs.vxrm, vxsat);
        break;
      }
      default:
    ...
    case 19: { // vfsqrt.v, vfrsqrt7.v, vfrec7.v, vfclass.v
      vector_op_vix<Funary1, uint8_t, uint16_t, uint32_t, uint64_t>(rsrc0, vreg_file, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 24: { // vmfeq.vv
      vector_op_vv_mask<Feq, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 25: { // vmfle.vv
      vector_op_vv_mask<Fle, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 27: { // vmflt.vv
      vector_op_vv_mask<Flt, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 28: { // vmfne.vv
      vector_op_vv_mask<Fne, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 32: { // vfdiv.vv
      vector_op_vv<Fdiv, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 36: { // vfmul.vv
      vector_op_vv<Fmul, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 40: { // vfmadd.vv
      vector_op_vv<Fmadd, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 41: { // vfnmadd.vv
      vector_op_vv<Fnmadd, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 42: { // vfmsub.vv
      vector_op_vv<Fmsub, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 43: { // vfnmsub.vv
      vector_op_vv<Fnmsub, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 44: { // vfmacc.vv
      vector_op_vv<Fmacc, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 45: { // vfnmacc.vv
      vector_op_vv<Fnmacc, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 46: { // vfmsac.vv
      vector_op_vv<Fmsac, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 47: { // vfnmsac.vv
      vector_op_vv<Fnmsac, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 48: { // vfwadd.vv
      vector_op_vv_w<Fadd, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 51:   // vfwredosum.vs - treated the same as vfwredosum.vs
    case 49: { // vfwredusum.vv
      vector_op_vv_red_wf<Fadd, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 50: { // vfwsub.vv
      vector_op_vv_w<Fsub, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 52: { // vfwadd.wv
      vector_op_vv_wfv<Fadd, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 54: { // vfwsub.wv
      vector_op_vv_wfv<Fsub, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 56: { // vfwmul.vv
      vector_op_vv_w<Fmul, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 60: { // vfwmacc.vv
      vector_op_vv_w<Fmacc, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 61: { // vfwnmacc.vv
      vector_op_vv_w<Fnmacc, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 62: { // vfwmsac.vv
      vector_op_vv_w<Fmsac, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 63: { // vfwnmsac.vv
  ...
  case 2: { // mask vector - vector
    ...
    case 1: { // vredand.vs
      vector_op_vv_red<And, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 2: { // vredor.vs
      vector_op_vv_red<Or, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 3: { // vredxor.vs
      vector_op_vv_red<Xor, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 4: { // vredminu.vs
      vector_op_vv_red<Min, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 5: { // vredmin.vs
      vector_op_vv_red<Min, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 6: { // vredmaxu.vs
      vector_op_vv_red<Max, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 7: { // vredmax.vs
      vector_op_vv_red<Max, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 8: { // vaaddu.vv
      uint32_t vxsat = 0; // saturation is not relevant for this operation
      vector_op_vv_sat<Aadd, uint8_t, uint16_t, uint32_t, uint64_t, __uint128_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask, vcsrs.vxrm, vxsat);
    } break;
    case 9: { // vaadd.vv
      uint32_t vxsat = 0; // saturation is not relevant for this operation
      vector_op_vv_sat<Aadd, int8_t, int16_t, int32_t, int64_t, __int128_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask, vcsrs.vxrm, vxsat);
    } break;
    case 10: { // vasubu.vv
      uint32_t vxsat = 0; // saturation is not relevant for this operation
      vector_op_vv_sat<Asub, uint8_t, uint16_t, uint32_t, uint64_t, __uint128_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask, vcsrs.vxrm, vxsat);
    } break;
    case 11: { // vasub.vv
      uint32_t vxsat = 0; // saturation is not relevant for this operation
    ...
    case 18: { // vzext.vf8, vsext.vf8, vzext.vf4, vsext.vf4, vzext.vf2, vsext.vf2
      ...
      vector_op_vix_ext<Xunary0>(rsrc0, vreg_file, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 20: { // vid.v
      vector_op_vid(vreg_file, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 23: { // vcompress.vm
      vector_op_vv_compress<uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl);
    } break;
    case 24: { // vmandn.mm
      vector_op_vv_mask<AndNot>(vreg_file, rsrc0, rsrc1, rdest, warp.vl);
    } break;
    case 25: { // vmand.mm
      vector_op_vv_mask<And>(vreg_file, rsrc0, rsrc1, rdest, warp.vl);
    } break;
    case 26: { // vmor.mm
      vector_op_vv_mask<Or>(vreg_file, rsrc0, rsrc1, rdest, warp.vl);
    } break;
    case 27: { // vmxor.mm
      vector_op_vv_mask<Xor>(vreg_file, rsrc0, rsrc1, rdest, warp.vl);
    } break;
    case 28: { // vmorn.mm
      vector_op_vv_mask<OrNot>(vreg_file, rsrc0, rsrc1, rdest, warp.vl);
    } break;
    case 29: { // vmnand.mm
      vector_op_vv_mask<Nand>(vreg_file, rsrc0, rsrc1, rdest, warp.vl);
    } break;
    case 30: { // vmnor.mm
      vector_op_vv_mask<Nor>(vreg_file, rsrc0, rsrc1, rdest, warp.vl);
    } break;
    case 31: { // vmxnor.mm
      vector_op_vv_mask<Xnor>(vreg_file, rsrc0, rsrc1, rdest, warp.vl);
    } break;
    case 32: { // vdivu.vv
      vector_op_vv<Div, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 33: { // vdiv.vv
      vector_op_vv<Div, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 34: { // vremu.vv
      vector_op_vv<Rem, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 35: { // vrem.vv
      vector_op_vv<Rem, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 36: { // vmulhu.vv
      vector_op_vv<Mulhu, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 37: { // vmul.vv
      vector_op_vv<Mul, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 38: { // vmulhsu.vv
      vector_op_vv<Mulhsu, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 39: { // vmulh.vv
      vector_op_vv<Mulh, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 41: { // vmadd.vv
      vector_op_vv<Madd, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 43: { // vnmsub.vv
      vector_op_vv<Nmsub, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 45: { // vmacc.vv
      vector_op_vv<Macc, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 47: { // vnmsac.vv
      vector_op_vv<Nmsac, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 48: { // vwaddu.vv
      vector_op_vv_w<Add, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 49: { // vwadd.vv
      vector_op_vv_w<Add, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 50: { // vwsubu.vv
      vector_op_vv_w<Sub, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 51: { // vwsub.vv
      vector_op_vv_w<Sub, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 52: { // vwaddu.wv
      vector_op_vv_wv<Add, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 53: { // vwadd.wv
      vector_op_vv_wv<Add, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 54: { // vwsubu.wv
      vector_op_vv_wv<Sub, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 55: { // vwsub.wv
      vector_op_vv_wv<Sub, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 56: { // vwmulu.vv
      vector_op_vv_w<Mul, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 58: { // vwmulsu.vv
      vector_op_vv_w<Mulsu, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 59: { // vwmul.vv
      vector_op_vv_w<Mul, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 60: { // vwmaccu.vv
      vector_op_vv_w<Macc, uint8_t, uint16_t, uint32_t, uint64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 61: { // vwmacc.vv
      vector_op_vv_w<Macc, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 63: { // vwmaccsu.vv
  ...
  case 3: { // vector - immidiate
    ...
    case 3: { // vrsub.vi
      vector_op_vix<Rsub, int8_t, int16_t, int32_t, int64_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 9: { // vand.vi
      vector_op_vix<And, int8_t, int16_t, int32_t, int64_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 10: { // vor.vi
      vector_op_vix<Or, int8_t, int16_t, int32_t, int64_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 11: { // vxor.vi
      vector_op_vix<Xor, int8_t, int16_t, int32_t, int64_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 12: { // vrgather.vi
      vector_op_vix_gather<uint8_t, uint16_t, uint32_t, uint64_t>(uimmsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, warp.vlmax, vmask);
    } break;
    case 14: { // vslideup.vi
      vector_op_vix_slide<uint8_t, uint16_t, uint32_t, uint64_t>(uimmsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, 0, vmask, false);
    } break;
    case 15: { // vslidedown.vi
      vector_op_vix_slide<uint8_t, uint16_t, uint32_t, uint64_t>(uimmsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, warp.vlmax, vmask, false);
    } break;
    case 16: { // vadc.vim
      vector_op_vix_carry<Adc, uint8_t, uint16_t, uint32_t, uint64_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl);
    } break;
    case 17: { // vmadc.vi, vmadc.vim
      vector_op_vix_carry_out<Madc, uint8_t, uint16_t, uint32_t, uint64_t, __uint128_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 23: { // vmv.v.i
      if (vmask) { // vmv.v.i
        if (rsrc0 != 0) {
        ...
        vector_op_vix<Mv, int8_t, int16_t, int32_t, int64_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, vmask);
      } else { // vmerge.vim
        vector_op_vix_merge<int8_t, int16_t, int32_t, int64_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, vmask);
      }
    } break;
    case 24: { // vmseq.vi
      vector_op_vix_mask<Eq, int8_t, int16_t, int32_t, int64_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 25: { // vmsne.vi
      vector_op_vix_mask<Ne, int8_t, int16_t, int32_t, int64_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 26: { // vmsltu.vi
      vector_op_vix_mask<Lt, uint8_t, uint16_t, uint32_t, uint64_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 27: { // vmslt.vi
      vector_op_vix_mask<Lt, int8_t, int16_t, int32_t, int64_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 28: { // vmsleu.vi
      vector_op_vix_mask<Le, uint8_t, uint16_t, uint32_t, uint64_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 29: { // vmsle.vi
      vector_op_vix_mask<Le, int8_t, int16_t, int32_t, int64_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 30: { // vmsgtu.vi
      vector_op_vix_mask<Gt, uint8_t, uint16_t, uint32_t, uint64_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 31: { // vmsgt.vi
      vector_op_vix_mask<Gt, int8_t, int16_t, int32_t, int64_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 32: { // vsaddu.vi
      vector_op_vix_sat<Sadd, uint8_t, uint16_t, uint32_t, uint64_t, __uint128_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, vmask, 2, vcsrs.vxsat);
    } break;
    case 33: { // vsadd.vi
      vector_op_vix_sat<Sadd, int8_t, int16_t, int32_t, int64_t, __int128_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, vmask, 2, vcsrs.vxsat);
    } break;
    case 37: { // vsll.vi
      vector_op_vix<Sll, int8_t, int16_t, int32_t, int64_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 39: { // vmv1r.v, vmv2r.v, vmv4r.v, vmv8r.v
      ...
      vector_op_vv<Mv, int8_t, int16_t, int32_t, int64_t>(vreg_file, rsrc0, rsrc1, rdest, warp.vtype.vsew, nreg * VLEN / warp.vtype.vsew, vmask);
    } break;
    case 40: { // vsrl.vi
      vector_op_vix<SrlSra, uint8_t, uint16_t, uint32_t, uint64_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 41: { // vsra.vi
      vector_op_vix<SrlSra, int8_t, int16_t, int32_t, int64_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, vmask);
    } break;
    case 42: { // vssrl.vi
      uint32_t vxsat = 0; // saturation is not relevant for this operation
      vector_op_vix_scale<SrlSra, uint8_t, uint16_t, uint32_t, uint64_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, vmask, vcsrs.vxrm, vxsat);
    } break;
    case 43: { // vssra.vi
      uint32_t vxsat = 0; // saturation is not relevant for this operation
      vector_op_vix_scale<SrlSra, int8_t, int16_t, int32_t, int64_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, vmask, vcsrs.vxrm, vxsat);
    } break;
    case 44: { // vnsrl.wi
      uint32_t vxsat = 0; // saturation is not relevant for this operation
      vector_op_vix_n<SrlSra, uint8_t, uint16_t, uint32_t, uint64_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, vmask, 2, vxsat);
    } break;
    case 45: { // vnsra.wi
      uint32_t vxsat = 0; // saturation is not relevant for this operation
      vector_op_vix_n<SrlSra, int8_t, int16_t, int32_t, int64_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, vmask, 2, vxsat);
    } break;
    case 46: { // vnclipu.wi
      vector_op_vix_n<Clip, uint8_t, uint16_t, uint32_t, uint64_t>(immsrc, vreg_file, rsrc0, rdest, warp.vtype.vsew, warp.vl, vmask, vcsrs.vxrm, vcsrs.vxsat);
    } break;
    case 47: { // vnclip.wi
