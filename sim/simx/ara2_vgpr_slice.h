...
class Ara2_Vgpr_Slice : public SimObject<Ara2_Vgpr_Slice<NUM_REQS, NUM_BANKS>> {
public:
  ...
  Ara2_Vgpr_Slice(const SimContext &ctx)
    : SimObject<Ara2_Vgpr_Slice<NUM_REQS, NUM_BANKS>>(ctx, "gpr-unit")
